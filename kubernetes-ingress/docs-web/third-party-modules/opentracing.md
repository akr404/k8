...
This document explains how to use OpenTracing with the Ingress Controller. Additionally, we have an [example](https://github.com/nginxinc/kubernetes-ingress/blob/master/docs/opentracing.md) on how to enable OpenTracing for a simple web application using Jaeger as a tracer.
